...
FUNCTION(OSG_SETUP_LIBRARY_BUILD PROJ_DEFINE)
    ...
    IF(OSG_ENABLE_FCD2CODE AND Python_Interpreter_FOUND)
    ...
    ENDIF(OSG_ENABLE_FCD2CODE AND Python_Interpreter_FOUND)
...
FUNCTION(OSG_SETUP_PYTHON_BUILD)
  ...
  IF(${PROJECT_NAME}_NO_PYTHON OR NOT Python_FOUND)
      RETURN()
  ENDIF(${PROJECT_NAME}_NO_PYTHON OR NOT Python_FOUND)
  ...
  IF(OSG_CAN_REGEN_PYTHON_BINDINGS)
    ...
    FILE(APPEND ${_OSG_GEN_SETUP_FILE} "  \"${Python_INCLUDE_DIR}\",\n")
...
#      SET(OSG_PYTHON_SUPPORT_DIR "${OpenSG_DIR}/share/OpenSG/python")
  ...
  IF(EXISTS "${OSG_PYTHON_${PROJECT_NAME}_MODULE_DIR}/generated" AND NOT ${PROJECT_NAME}_PYTHON_GET_ONLY)
    ...
    ADD_LIBRARY(${PROJECT_NAME}Py SHARED ${_OSG_BIND_SRC})
...
#    INCLUDE_DIRECTORIES(${OSG_BOOST_INCDIRS})
    ...
    TARGET_LINK_LIBRARIES(${PROJECT_NAME}Py ${Python_LIBRARY_RELEASE})
...
#              COMPONENT      release_no_opt_runtimes
    ...
    ELSE(WIN32)   
      GET_FILENAME_COMPONENT(_PY_VERSION_DIR ${_Python_INCLUDE_DIR} NAME)
...
MACRO(OSG_BOOST_DEP_SETUP)
    ...
    IF(Boost_FOUND)
        ...
        IF(Python_INCLUDE_DIR AND Python_LIBRARY_RELEASE)
          FIND_PACKAGE(Boost COMPONENTS python${OSGBUILD_PYTHON_VERSION})
        ENDIF(Python_INCLUDE_DIR AND Python_LIBRARY_RELEASE)
        ...
        SET(Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY ${Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY}
                                     CACHE INTERNAL "")
        SET(Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_DEBUG ${Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_DEBUG}
                                           CACHE INTERNAL "")
        SET(Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_RELEASE
           ${Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_RELEASE}
           CACHE INTERNAL "")
        ...
        IF(CMAKE_BUILD_TYPE STREQUAL "Debug" OR
          ...
          SET(OSG_BOOST_PYTHON_LIBS ${Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_DEBUG})
        ...
        ELSE()
          ...
          SET(OSG_BOOST_PYTHON_LIBS ${Boost_PYTHON${OSGBUILD_PYTHON_VERSION}_LIBRARY_RELEASE})
